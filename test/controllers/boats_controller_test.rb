...
class BoatsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create boat" do
    assert_difference('Boat.count') do
      post boats_url, params: { boat: { name: @boat.name, tracking_email: @boat.tracking_email, user_id: @boat.user_id } }
    end
  ...
  test "should update boat" do
    patch boat_url(@boat), params: { boat: { name: @boat.name, tracking_email: @boat.tracking_email, user_id: @boat.user_id } }
